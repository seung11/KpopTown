...
<section id="main-wrap">
  ...
  <section id="main">
  	<div class="container">	
  	 		<h1>회원가입</h1>
	<form action="/kpop/member/signup" method="post" onsubmit="return check()">
		<div class="signup-wrap">
	       <!-- 회원가입 input -->
	       <div class="signup-info id-info">
	      	 <label>아이디</label>
	      	 <div class="signup-input">
	      	 	<input type="text" class="id_input" name="userid" id="userid" placeholder="8자이상+영문,숫자 포함" required="required">
	      		<div id="idmsg"></div>	
	      	</div>
	      	<!-- signup-input -->
	      </div> 
	     ...
	     <div class="signup-info repw-info">
	      	<label>비밀번호 확인</label>
	      	<div class="signup-input">
	     ...
	     <div class="signup-info name-Info">
	     	<label>이름</label>
	      	<div class="signup-input">
	      		<input type="text" name="userName" id="userName" placeholder="이름" required="required" maxlength="10">
	      		<div id="name_msg"></div>
	     	</div>
	      	<!-- signup-input End -->
	     </div>
	     ...
	     <div class="signup-info">
	     	<label>전화번호</label>
	      	<div class="signup-input">
	      		<input type="tel" maxlength="11" name="userPhone" id="userPhone" placeholder="-제외하고 입력해주세요" required="required">
	      	</div>
	      	<!-- signup-input End -->
	     </div>
	     <!-- signup-info End -->
	     ...
	     <!-- signup-info End -->
	      ...
	      <!-- 주소 API -->
	     <div class="addrAPI">
	        <div class="signup-info addr-info">
	        	<label>주소</label>
	        	<div class="signup-input addr-input">
	        		<div class="zipe">
    ...
    function initLayerPosition(){
	  ...
	  <!-- arrdAPI End -->   	
		 <div class="signup-Btn">	
	    	 <input type="submit" class="signup-ok" value="회원가입"/> 
